...
perl -0777 -i -pe "s/const SERVER_VERSION = envStr\(process\.env\.WEBHOOK_SERVER_VERSION, \"[^\"]+\"\);/const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, \"${VERSION}\");/g" webhook/server.js
